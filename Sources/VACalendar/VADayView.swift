...
@objc
public protocol VADayViewAppearanceDelegate: AnyObject {
    ...
    @objc optional func textBackgroundBorderWidth(for state: VADayState) -> CGFloat
    @objc optional func textBackgroundBorderColor(for state: VADayState) -> UIColor
...
protocol VADayViewDelegate: AnyObject {
...
class VADayView: UIView {
    ...
    private func setState(_ state: VADayState) {
        ...
        dateLabel.layer.borderColor = dayViewAppearanceDelegate?.textBackgroundBorderColor?(for: state).cgColor ?? dateLabel.layer.borderColor
        dateLabel.layer.borderWidth = dayViewAppearanceDelegate?.textBackgroundBorderWidth?(for: state) ?? dateLabel.layer.borderWidth
